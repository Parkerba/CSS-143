...
public class List<T> {
    ...
    public static void main(String[] args) throws LinkedListException {
        ...
        try {
            ...
            System.out.println("This throws a LinkedListException\n");
        }
        stringList.insert("First Data item", 0);
        stringList.append("Second Data item");
        System.out.println("Number of elements " + stringList.size());
        System.out.println(stringList);
        stringList.remove(0);
        stringList.insert("New First element", 0);
        System.out.println("\nFirst element has been replaced! \n" + stringList);
        System.out.println("\nNumber of elements " + stringList.size());
        stringList.delete(1);
    ...
    public String toString() {
        ...
        while (pointer.next != null) {
            ...
            retval = retval + "Index " + counter + ":" + pointer.data + "   ";
            pointer = pointer.next;
            counter++;
        }
        retval = retval + "Index " + counter + ":" + pointer.data;
