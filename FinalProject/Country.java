 ...
 * @version 3/5/2019
 */
public class Country extends Music implements Cloneable{
    public Country() {
    }
    ...
    public double CalculateSatisfaction(Desire other) {
        if (other instanceof Country && (this.descriptor.equals(((Country) other).descriptor) || this.descriptor.equals(""))) {
            return 1;
        } else if (other instanceof Country) return .65;
    ...
    public String toString() {
        return "Listening to country " + descriptor;
    }
}
